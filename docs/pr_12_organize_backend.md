...
이번 1차 리팩토링의 범위는 폴더 구조 정리에 한정했습니다.
...
flowchart TB
  subgraph APP["app"]
    ...
    subgraph INTEGRATIONS["integrations"]
      MARKET_DATA["market_data.py<br/>yfinance 어댑터"]
...
| `app.integrations` | 외부 시스템 어댑터 | yfinance, Kakao OAuth, Kakao 알림 같은 외부 연동 세부사항을 담당합니다. |
